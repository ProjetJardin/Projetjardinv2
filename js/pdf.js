...
const GABARIT_SANS_TVA = {
  ...
  maxLignesParPage: 6,
  yPastilleTtc: 233,           // baseline fixe de "Total TTC :" sur le gabarit
  xValeurTtc: 498,
...
const GABARIT_AVEC_TVA = {
  ...
  maxLignesParPage: 4,
  yTotalHt: 302.85,            // baseline fixe de "Total H.T :"
  yTva: 280.15,                // baseline fixe de "TVA :"
  yPastilleTtc: 258.45,        // baseline fixe de "Total TTC :"
