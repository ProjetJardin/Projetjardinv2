...
const GABARIT_SANS_TVA = {
  ...
  maxLignesParPage: 6,
  yPastilleTtc: 240,           // baseline fixe de "Total TTC :" sur le gabarit
  xValeurTtc: 498,
...
const GABARIT_AVEC_TVA = {
  ...
  maxLignesParPage: 4,
  yTotalHt: 310,                // baseline fixe de "Total H.T :"
  yTva: 287,                    // baseline fixe de "TVA :"
  yPastilleTtc: 265,            // baseline fixe de "Total TTC :"
